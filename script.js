...
document.querySelectorAll('.icon').forEach(button => {
  ...
  const games = [
    ...
    { title: "Planet Coaster", imageUrl: "https://static.wikia.nocookie.net/game-pedia/images/a/a9/PlanetCoaster.jpeg/revision/latest?cb=20230108093231&path-prefix=de", platform: "PC", dlc: "No DLC", launcher: "Steam" },
