...
document.querySelectorAll('.icon').forEach(button => {
  ...
  const games = [
    ...
    { title: "Vampire: The Masquerade - Shadows of New York", imageUrl: "https://example.com/vampire_shadows_of_new_york.jpg", platform: "PC", dlc: "Complete Edition", launcher: "Steam" },
